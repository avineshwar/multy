...
var subnetMetadata = resources.ResourceMetadata[*resourcespb.SubnetArgs, *Subnet, *resourcespb.SubnetResource]{
	DepsGetter: func(_ string, args *resourcespb.SubnetArgs, _ resources.Resources) (res []string, err error) {
	...
	ExportFunc:        func(r *Subnet) (*resourcespb.SubnetArgs, error) { return r.Args, nil },
	AbbreviatedName:   "vn",
}
