...
var lambdaMetadata = resources.ResourceMetadata[*resourcespb.LambdaArgs, *Lambda, *resourcespb.LambdaResource]{
	DepsGetter: func(_ string, args *resourcespb.LambdaArgs, _ resources.Resources) (res []string, err error) {
		if args.SourceCodeObjectId != "" {
			res = append(res, args.SourceCodeObjectId)
		}
		return res, err
	},
	...
	ExportFunc:        func(r *Lambda) (*resourcespb.LambdaArgs, error) { return r.Args, nil },
...
func CreateLambda(resourceId string, args *resourcespb.LambdaArgs, others resources.Resources) (*Lambda, error) {
	if args.CommonParameters.ResourceGroupId == "" {
		rgId := GetDefaultResourceGroupIdString("func", common.RandomString(8))
