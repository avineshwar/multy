...
var dbMetadata = resources.ResourceMetadata[*resourcespb.DatabaseArgs, *Database, *resourcespb.DatabaseResource]{
	DepsGetter: func(_ string, args *resourcespb.DatabaseArgs, _ resources.Resources) (res []string, err error) {
		return args.SubnetIds, nil
	},
	CreateFunc:        CreateDatabase,
	UpdateFunc:        UpdateDatabase,
	ReadFromStateFunc: DatabaseFromState,
	ExportFunc:        func(r *Database) (*resourcespb.DatabaseArgs, error) { return r.Args, nil },
